...
function preload(){
   bubble = loadImage("imageedit_1_5632497561.gif");
   alarmSound = loadSound("alarmSound.mp3");
   balloonPopSound = loadSound("balloonPopSound.mp3");
}
...
if(mousePressedOver(circle2)){
  balloonPopSound.play();
}
if(mousePressedOver(circle3)){
  balloonPopSound.play();
}
if(mousePressedOver(circle4)){
  balloonPopSound.play();
}
if(mousePressedOver(circle5)){
  balloonPopSound.play();
}
if(mousePressedOver(circle6)){
  balloonPopSound.play();
}
if(mousePressedOver(circle7)){
  balloonPopSound.play();
}
if(mousePressedOver(circle8)){
  balloonPopSound.play();
}
if(mousePressedOver(circle9)){
  balloonPopSound.play();
}
if(mousePressedOver(circle10)){
  balloonPopSound.play();
}*/
